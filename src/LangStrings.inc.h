...
DECLARE_STRING(FREIGHT_TELEPORTER)
DECLARE_STRING(FREIGHT_TELEPORTER_DESCRIPTION)
DECLARE_STRING(BASIC_FREIGHT_TELEPORTER)
DECLARE_STRING(BASIC_FREIGHT_TELEPORTER_DESCRIPTION)
DECLARE_STRING(ADVANCED_FREIGHT_TELEPORTER)
DECLARE_STRING(ADVANCED_FREIGHT_TELEPORTER_DESCRIPTION)
...
DECLARE_STRING(DRIVE_CLASS10)
DECLARE_STRING(DRIVE_CLASS11)
DECLARE_STRING(DRIVE_CLASS12)
DECLARE_STRING(DRIVE_CLASS13)
DECLARE_STRING(DRIVE_CLASS14)
DECLARE_STRING(DRIVE_CLASS15)
DECLARE_STRING(DRIVE_CLASS16)
DECLARE_STRING(DRIVE_CLASS17)
DECLARE_STRING(DRIVE_CLASS18)
DECLARE_STRING(DRIVE_CLASS19)
DECLARE_STRING(DRIVE_CLASS20)
...
DECLARE_STRING(HYPERSPACE_PERMA_CLOUD)
...
DECLARE_STRING(DESELECT_ALL_OBJECTS)
...
DECLARE_STRING(CAMERA_FREE_VIEW)
DECLARE_STRING(FREELOOK_UP)
DECLARE_STRING(FREELOOK_DOWN)
DECLARE_STRING(FREELOOK_LEFT)
DECLARE_STRING(FREELOOK_RIGHT)
DECLARE_STRING(FREELOOK_CENTRE)
...
DECLARE_STRING(JUMP_FAILED_ENTERED_PHASE_RANGE)
DECLARE_STRING(JUMP_FAILED_LEFT_PHASE_RANGE)
DECLARE_STRING(JUMP_FAILED_HYPERCLOUD_INUSE)
DECLARE_STRING(TAKEOFF)
DECLARE_STRING(MANUAL_CONTROL)
DECLARE_STRING(MANEUVER_CONTROL_UNAVAILABLE)
DECLARE_STRING(MANEUVER_CONTROL_OFF)
DECLARE_STRING(MANEUVER_CONTROL_ON)
DECLARE_STRING(TRANSIT_CONTROL_UNAVAILABLE)
DECLARE_STRING(TRANSIT_CONTROL_OFF)
DECLARE_STRING(TRANSIT_CONTROL_ON)
DECLARE_STRING(JUMP_CONTROL_UNAVAILABLE)
DECLARE_STRING(JUMP_CONTROL_OFF)
DECLARE_STRING(JUMP_CONTROL_ON)
DECLARE_STRING(PHASE_JUMP_CONTROL_UNAVAILABLE)
DECLARE_STRING(PHASE_JUMP_CONTROL_OFF)
DECLARE_STRING(PHASE_JUMP_CONTROL_ON)
DECLARE_STRING(COMPUTER_SPEED_CONTROL)
DECLARE_STRING(COMPUTER_HEADING_CONTROL)
DECLARE_STRING(AUTOPILOT_UNAVAILABLE)
DECLARE_STRING(AUTOPILOT_OFF)
...
DECLARE_STRING(P_NO_TARGET)
DECLARE_STRING(P_UI_FUEL)
DECLARE_STRING(P_UI_HYDROGEN)
DECLARE_STRING(P_UI_TEMP)
DECLARE_STRING(P_UI_WEAP)
DECLARE_STRING(P_UI_HULL)
DECLARE_STRING(P_UI_SHLD)
...
DECLARE_STRING(TUTORIAL_1)
DECLARE_STRING(TUTORIAL_2)
DECLARE_STRING(TUTORIAL_3)
DECLARE_STRING(TUTORIAL_4)
DECLARE_STRING(TUTORIAL_5)
DECLARE_STRING(TUTORIAL_6)
